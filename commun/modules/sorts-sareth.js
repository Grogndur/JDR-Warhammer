...
/* Rendues accessibles aux boutons de la page. */
  ...
  window.deleteSort = deleteSort;
  window.editSort = editSort;
  window.applySortEditable = applySortEditable;
  window.renderSorts = renderSorts;
  window.toggleSortForm = toggleSortForm;
