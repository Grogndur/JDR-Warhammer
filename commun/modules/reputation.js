...
var FO_AXES = {
  fin: { lbl:'Financier',     court:'Fin' },
  com: { lbl:'Commercial',    court:'Com' },
  pol: { lbl:'Politique',     court:'Pol' },
  inf: { lbl:'Influence',     court:'Inf' },
  inv: { lbl:'Investisseurs', court:'Inv' },
  mdo: { lbl:'Main-d\u2019\u0153uvre',  court:'M\u0152' }
};

var FO_BENEF_CATS = {
  revenu:     'Revenu',
  prix:       'Prix avantageux',
  commerce:   'Voie de commerce',
  influence:  'Influence',
  mainoeuvre: 'Main-d\u2019\u0153uvre'
};

var FO_SOLIDITE_LBL={ verbal:'Verbal', scelle:'Scell\u00e9', officiel:'Officiel' };

var FO_SOLIDITE_CYCLE=['verbal','scelle','officiel'];
...
/* Rendues accessibles aux boutons de la page. */
  ...
  window.foToggleForm = foToggleForm;
  window.foEsc = foEsc;
  window.foTab = foTab;
  window.foRenderStats = foRenderStats;
  window.foRenderEnt = foRenderEnt;
  window.foToggleCond = foToggleCond;
  window.foTreso = foTreso;
  window.foAddEnt = foAddEnt;
  window.foSetDev = foSetDev;
  window.foCapital = foCapital;
  window.foSetSante = foSetSante;
  window.foAddBenef = foAddBenef;
  window.foDelBenef = foDelBenef;
  window.foDelEnt = foDelEnt;
  window.foRenderReg = foRenderReg;
  window.foAddReg = foAddReg;
  window.foDelReg = foDelReg;
  window.foRenderAcc = foRenderAcc;
  window.foAddAcc = foAddAcc;
  window.foCycleSolidite = foCycleSolidite;
  window.foDelAcc = foDelAcc;
  window.foRenderEssor = foRenderEssor;
  window.foUseEssor = foUseEssor;
  window.foResetEssor = foResetEssor;
