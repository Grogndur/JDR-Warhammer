...
/* Rendues accessibles aux boutons de la page. */
  ...
  window.jetMeditation = jetMeditation;
  window.jetAffinite = jetAffinite;
  window.medBFM = medBFM;
  window.medSeuilBase = medSeuilBase;
