/* Le Livre — mécanique de Kantagoran Effendyl
...
const LIVRE_CATS = ['legendaire','lieux','faune'];


/* Rendues accessibles aux boutons de la page. */
  window.livreLoad = livreLoad;
  window.livreSave = livreSave;
  window.livreTab = livreTab;
  window.livreRender = livreRender;
  window.livreNextStatut = livreNextStatut;
  window.livreDelete = livreDelete;
  window.livreToggleForm = livreToggleForm;
  window.livreAdd = livreAdd;
