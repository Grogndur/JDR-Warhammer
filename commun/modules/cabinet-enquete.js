...
/* Rendues accessibles aux boutons de la page. */
  window.coteTier = coteTier;
  window.calcPrime = calcPrime;
  window.timerCls = timerCls;
  window.timerNote = timerNote;
  window.coteBonusPct = coteBonusPct;
  window.ceLoad = ceLoad;
  window.ceSave = ceSave;
  window.ceRender = ceRender;
  window.ceRenderCote = ceRenderCote;
  window.ceRenderCoteBonus = ceRenderCoteBonus;
  window.ceRenderStats = ceRenderStats;
  window.ceTab = ceTab;
  window.ceToggleForm = ceToggleForm;
  window.ceToggleModifForm = ceToggleModifForm;
  window.ceRenderDossiers = ceRenderDossiers;
  window.ceRenderDossierList = ceRenderDossierList;
  window.ceSaveField = ceSaveField;
  window.ceSetComp = ceSetComp;
  window.ceCycleStatut = ceCycleStatut;
  window.ceTimerTick = ceTimerTick;
  window.ceTimerSetMax = ceTimerSetMax;
  window.ceAddModif = ceAddModif;
  window.ceCloseDossier = ceCloseDossier;
  window.ceDelDossier = ceDelDossier;
  window.ceAddDossier = ceAddDossier;
  window.ceShowJournal = ceShowJournal;
  window.ceHideJournal = ceHideJournal;
  window.ceAddJournalEntry = ceAddJournalEntry;
  window.ceDelJournalEntry = ceDelJournalEntry;
  window.ceRenderIndics = ceRenderIndics;
  window.ceSetIndicFiab = ceSetIndicFiab;
  window.ceIndicCycleStatut = ceIndicCycleStatut;
  window.ceAddIndicLog = ceAddIndicLog;
  window.ceDelIndicLog = ceDelIndicLog;
  window.ceDelIndic = ceDelIndic;
  window.ceToggleIndicLog = ceToggleIndicLog;
  window.ceHideIndicLog = ceHideIndicLog;
  window.ceShowIndicLink = ceShowIndicLink;
  window.ceHideIndicLink = ceHideIndicLink;
  window.ceLinkIndicDossier = ceLinkIndicDossier;
  window.ceAddIndic = ceAddIndic;
  window.ceRenderCmd = ceRenderCmd;
  window.ceCmdSetSatis = ceCmdSetSatis;
  window.ceDelCmd = ceDelCmd;
  window.ceAddCmd = ceAddCmd;
